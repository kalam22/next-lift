                ...
                <div className="bg-white dark:bg-[#0f172a] rounded-3xl border border-[#e2e8f0] dark:border-[#1e293b] shadow-xl shadow-gray-200/50 dark:shadow-black/30 overflow-hidden">
                    ...
                    <div className="px-8 pt-10 pb-8 border-b border-[#f1f5f9] dark:border-[#1e293b]">
                        <div className="flex items-center gap-4 mb-6">
                            <div className="flex aspect-square size-12 items-center justify-center rounded-2xl bg-primary text-white shadow-lg shadow-primary/30">
                    ...
                    <form onSubmit={handleSubmit} className="px-8 py-8 space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full flex items-center justify-center gap-2 px-6 py-3.5 bg-primary hover:bg-primary/90 disabled:opacity-60 text-white rounded-2xl text-sm font-black uppercase tracking-widest transition-all shadow-lg shadow-primary/20 disabled:cursor-not-allowed active:scale-[0.98] mt-2"
                        >
                            {loading ? (
                                <>
...
export default function LoginPage() {
    return (
        <Suspense fallback={
            <div className="min-h-screen bg-[#f0f4f8] dark:bg-[#0a0a0a] flex items-center justify-center">
