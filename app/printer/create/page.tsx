        ...
        <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center justify-center sm:justify-start gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-[#0f172a] dark:text-white tracking-tight">Tambah Printer</h1>
                        <p className="text-sm text-gray-400 font-medium">Daftarkan unit printer baru ke dalam inventaris.</p>
                    </div>
                </div>
            </div>

            <PrinterForm isEdit={false} />
        </div>
    )
}
