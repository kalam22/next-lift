...
export default function ToolsJaringanPage() {
  const { canCreate, canEdit, canDelete, canExport, canImport } = usePermissions('tools_jaringan')
  ...
  return (
    <div className="min-h-screen mesh-gradient dark:mesh-gradient-dark p-4 sm:p-6 lg:p-8 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <CreateModal
        ...
        title="Register Tools Jaringan"
        subtitle="Tambah data Tools Jaringan baru"
      >
        <StandardEntityForm
          config={STANDARD_ENTITY_CONFIGS.tools_jaringan}
