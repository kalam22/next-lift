...
export default function MousePage() {
  const { canCreate, canEdit, canDelete, canExport, canImport } = usePermissions('mouse')
  ...
  return (
    <div className="min-h-screen mesh-gradient dark:mesh-gradient-dark p-4 sm:p-6 lg:p-8 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <CreateModal
        ...
        title="Register Mouse"
        subtitle="Tambah data Mouse baru"
      >
        <StandardEntityForm
          config={STANDARD_ENTITY_CONFIGS.mouse}
