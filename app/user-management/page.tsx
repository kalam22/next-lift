                          ...
                          {String(user.id) !== session?.user?.id && (
                            <>
                              <button
                                ...
                                className={`p-2.5 bg-white dark:bg-[#0f172a] border border-gray-100 dark:border-white/5 rounded-xl hover:scale-110 transition-all hover:shadow-xl ${
                                  user.isActive
                                    ? 'text-gray-400 hover:text-orange-500 hover:shadow-orange-500/10'
                                    : 'text-gray-400 hover:text-green-500 hover:shadow-green-500/10'
                                }`}
