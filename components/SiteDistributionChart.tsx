...
const COLORS = ['#ec4899', '#f97316', '#10b981', '#3b82f6', '#8b5cf6', '#06b6d4', '#f59e0b', '#ef4444', '#14b8a6', '#6366f1']
...
function SiteDistributionChart({ data, title }: SiteDistributionChartProps) {
...
export default React.memo(SiteDistributionChart)
